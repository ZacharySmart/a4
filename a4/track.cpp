...
Track::Track(const int aTrackId, Song * songptr, const string & anMp3FileName ) : id{aTrackId},song{songptr}, mp3FileName{anMp3FileName} {//note base member initialisation
