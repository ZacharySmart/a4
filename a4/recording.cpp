...
Recording::Recording(const string & aTitle, 
           ...
           const string & aYear,
                     const int anID): title{aTitle}, artist{anArtist}, producer{aProducer}, year{aYear}, id{anID}, tracks{vector<Track*>(MAX_NUMBER_OF_TRACKS, NULL)} {//note base member init.
