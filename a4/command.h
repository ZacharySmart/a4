...
const string CMD_FOLLOW= "follow";//follow playlist
const string CMD_UNFOLLOW= "unfollow"; //unfollow playlist
const string CMD_SEARCH= "search";//search for objects
...
const int NumberOfAppCommands = 6;
